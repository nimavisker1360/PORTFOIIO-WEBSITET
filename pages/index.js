  ...
  return (
    <div className="bg-primary/60 h-full">
      ...
      <div className="w-[1200px] h-[800px] absolute right-0 bottom-0">
        {/* bg image */}
        <div
          className="bg-none xl:bg-native mt-10 ml-10   xl:bg-cover xl:bg-left xl:bg-no-repeat opacity-50 
        w-full h-[800px] absolute mix-blend-color-dodge translate-z-0"
        ></div>
        {/* particles */}
        <ParticleContainer />
        {/* avatar */}
